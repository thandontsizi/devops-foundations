...
- Command: sudo systmectl start docker/systemctl start docker
- Explanation: Starts the Docker service if it is not running.
...
- Explanation: Downloads the "hello-world" image from the Docker Hub to the local machine.
...
4.1. System Information About Docker:
- Command: docker info
- Explanation: Displays system-wide information about Docker.

4.2. Container Logs:
- Command: docker logs CONTAINER_ID
- Explanation: Displays logs produced by a container.
